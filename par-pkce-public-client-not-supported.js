...
const client = new auth0Issuer.Client({
  client_id: 'gA7gMkI2iR8iia6mTIgyhnjpSk66tb5X',
...
const url = `https://${process.env.DOMAIN}/authorize?client_id=gA7gMkI2iR8iia6mTIgyhnjpSk66tb5X&request_uri=${response.request_uri}`;
